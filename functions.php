...
function ig_scripts() {	
	...
	// Bootstrap CSS
	wp_enqueue_style( 'bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css', array(), IG_VERSION, 'all');

	// <link rel="stylesheet" type="text/css" href="css/theme-vendors.min.css">
	wp_enqueue_style( 'themevendorthemecss', get_template_directory_uri().'/css/theme-vendors.min.css', array(), IG_VERSION, 'all');

	// <link rel="stylesheet" type="text/css" href="css/style-theme.css" />
	wp_enqueue_style( 'stylethemecss', get_template_directory_uri().'/css/style-theme.css', array(), IG_VERSION, 'all');

	// <link rel="stylesheet" type="text/css" href="css/responsive.css" />
	wp_enqueue_style( 'responsivethemecss', get_template_directory_uri().'/css/responsive.css', array(), IG_VERSION, 'all');

	/* Feuille de styles personnalisée */
	wp_enqueue_style( 'customstyles', get_template_directory_uri().'/style.css', array(), IG_VERSION, 'all');

	// Font Awesome JS
	wp_enqueue_script( 'fontawesomejs', 'https://kit.fontawesome.com/cb8f0e6916.js', array(), IG_VERSION, true );
	
	// jQuery
	// wp_enqueue_script('jquery');

	// Bootstrap JS
	wp_enqueue_script( 'bootstrapjs', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js', array(), IG_VERSION, true );

	// <script type="text/javascript" src="js/jquery.min.js"></script>
	wp_enqueue_script( 'jquerytheme', get_template_directory_uri().'/js/jquery.min.js', array(), IG_VERSION, true );

	// <script type="text/javascript" src="js/theme-vendors.min.js"></script>
	wp_enqueue_script( 'themevendorthemejs', get_template_directory_uri().'/js/theme-vendors.min.js', array(), IG_VERSION, true );

	// <script type="text/javascript" src="js/main.js"></script>
	wp_enqueue_script( 'mainthemejs', get_template_directory_uri().'/js/main.js', array(), IG_VERSION, true );
